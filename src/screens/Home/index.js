        ...
        <View style={styles.content}>
          <ScrollView
            ...
            <View style={styles.gear}>
              <MaterialCommunityIcons color="#FFF" name="build" size={26} />
            </View>
            <View>
                ...
                <TouchableOpacity key={key} style={styles.card}>
                  <View style={styles.cardContent}>
                    ...
                    <View style={styles.cardContentDescription}>
                      <Text style={styles.cardContentDescriptionText}>
                        {card.description}
                      </Text>
                    </View>
                  </View>
                  ...
                  <TouchableOpacity key={key} style={styles.recently}>
                    <View style={styles.recentlyContent}>
                      <Image
                        resizeMethod="resize"
                        resizeMode="stretch"
                        style={styles.recentlyContentImage}
                        source={{uri: recently.img}}
                      />
                      <View style={styles.recentlyContentDescription}>
                        <Text style={styles.recentlyContentDescriptionText}>
                          {recently.author}
                        </Text>
                      </View>
                    </View>
                  ...
                  <TouchableOpacity key={key} style={styles.playlist}>
                    <View style={styles.playlistContent}>
                      <Image
                        resizeMethod="resize"
                        resizeMode="stretch"
                        style={styles.playlistContentImage}
                        source={{uri: playlist.img}}
                      />
                      <View style={styles.playlistContentDescription}>
                        <Text style={styles.playlistContentDescriptionText}>
                          {playlist.author}
                        </Text>
                      </View>
                    </View>
            ...
            <View>
              <Text style={styles.subTitle}>Suggested artists</Text>
            </View>
            <View style={styles.playlists}>
              <ScrollView showsHorizontalScrollIndicator={false} horizontal>
                {tmpArtists.map((artist, key) => (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate('ProfileAuthor', {author: artist})
                    }
                    key={key}
                    style={styles.artist}>
                    <View style={styles.artistContent}>
                      <Image
                        resizeMethod="resize"
                        resizeMode="stretch"
                        style={styles.artistContentImage}
                        source={{uri: artist.img}}
                      />
                      <View style={styles.artistContentDescription}>
                        <Text style={styles.artistContentDescriptionText}>
                          {artist.author}
                        </Text>
                      </View>
                    </View>

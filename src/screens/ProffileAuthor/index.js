            ...
            <ScrollView
              ...
              <View style={styles.contentAuthor}>
                <View style={styles.information}>
                  ...
                  <Text style={styles.numberFollwers}>
                    718.712 likes * 2h 28m
                  </Text>
                  <View style={styles.actions}>
                    <TouchableOpacity
                      style={{...styles.buttonAction, marginRight: 10}}>
                      <MaterialCommunityIcons
                        name="favorite"
                        color="#1DB954"
                        size={28}
                    ...
                    <TouchableOpacity
                      style={{...styles.buttonAction, marginHorizontal: 10}}>
                      <MaterialCommunityIcons
                        style={{opacity: 0.6}}
                        name="cloud-download"
                        color="#FFF"
